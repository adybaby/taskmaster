...
import {
  DB_STATUS as PKG_DB_STATUS,
  VACANCY_STATUS as PKG_VACANCY_STATUS,
...
export const VACANCY_STATUS = PKG_VACANCY_STATUS;
export const VACANCY_ROLE = PKG_VACANCY_ROLE;
export const VACANCY_PRIORITY = PKG_VACANCY_PRIORITY;
export const INTEREST_STATUS = PKG_INTEREST_STATUS;
